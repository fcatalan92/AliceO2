...
void CheckTracksCosmics(std::string tracfile = "o2trac_its.root", std::string clusfile = "o2clus_its.root", std::string kinefile = "o2sim_Kine.root")
{
...
*/
  ...
  if (statGen > 0) {
    ...
    std::cout << "Good found tracks/event: " << statGoo / Float_t(nDataEvents) << ",  efficiency: " << eff << ",  fake-track rate: " << rat << " clone rate " << clonerat << std::endl;
  }
